     ...
     <div class="container py-5">
         <div class="row justify-content-start">
             <div class="col-lg-8 text-center text-lg-start">
                 ...
                 <div class="pt-2">
                    <a class="btn btn-light rounded-pill py-md-3 px-md-5 mx-2" href="{{ route('login') }}">{{ __('Login') }}</a>
                    <a class="btn btn-outline-light rounded-pill py-md-3 px-md-5 mx-2" href="{{ route('register') }}">{{ __('Register') }}</a>
                 </div>
     ...
     <div class="container">
         <div class="row gx-5">
             ...
             <div class="col-lg-7">
                 ...
                 <p>
                    We started Medica to end the frustrating search for our information when it comes to our most precious asset - our health.
                 </p><br/><br/>
